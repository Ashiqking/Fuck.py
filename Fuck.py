...
\x1b[1;97m┃\033[1;32m   ██    \033[1;33m██    ██ \033[1;36m████  ████\x1b[1;97m┃ \033[1;32mGITHUB  \033[1;31m:»\033[1;32mAshısh \x1b[1;97m┃
...
def menu():
    ...
    if sex in ['1']:
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=61559399982918');menu()
    elif sex in ['0']:
        sys.exit()
    else:
        menu()
...
def India():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{A} +91091{G}/{A}+91092{G}/{A}+91934{G}/{A}+91701');linex()
    code = input(f'{G1}[{A}?{G1}]{G1} CHOICE  {A}➢{G1} ')
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{A} 3000{G}/{A}5000{G}/{A}10000{G}/{A}99999');linex()
    limit = int(input(f'{G1}[{A}?{G1}]{G1} CHOICE  {A}➢{G1} '))
